...
const  VideoCard = ()=>{
    ...
    return(
     ...
     {commentBoxOpen ? (
        ...
        }} src="https://firebasestorage.googleapis.com/v0/b/class-demo-28b22.appspot.com/o/production%20ID_4678261.mp4?alt=media&token=43ab3b19-9238-4243-a1d8-1474001b9350" crossrigin="anonymous"></video>
       </div>
    )
}
